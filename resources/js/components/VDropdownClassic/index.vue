            ...
            >
              ...
              <span>{{option.period}}</span>
                ...
                <div class="pt-1.5 pb-4 px-4">
                    <div class="text-xs font-semibold text-slate-400 uppercase mb-2">Filter By Placement</div>
                    <VSelect placeholder="Placement" :options="options" ref="filterPlacementSelect" />
                </div>
            </div>
        </transition>
    </div>
