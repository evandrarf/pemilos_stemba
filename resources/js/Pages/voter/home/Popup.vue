...
const btn = "px-6 py-2 text-xl rounded-md border-2 border-black";
        ...
        >
            ...
            <div class="px-4 py-4">
                ...
                <p class="text-center text-lg" v-else>
                    Selamat datang {{ user.name }}. Silahkan pilih pasangan
                    calon ketua dan wakil ketua osis. Gunakan hak pilih anda
                    dengan bijak.
                </p>
            </div>
